module Ionide.FsNative.Analyzers.Tests.Performance.CombinePipedModuleFunctionsAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK.Testing
open Ionide.FsNative.Analyzers.Performance.CombinePipedModuleFunctionsAnalyzer
