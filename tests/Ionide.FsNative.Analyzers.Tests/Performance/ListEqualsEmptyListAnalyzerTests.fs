module Ionide.FsNative.Analyzers.Tests.Performance.ListEqualsEmptyListAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK.Testing
open Ionide.FsNative.Analyzers.Performance.ListEqualsEmptyListAnalyzer
