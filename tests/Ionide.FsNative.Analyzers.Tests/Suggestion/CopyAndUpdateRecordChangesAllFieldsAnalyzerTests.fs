module Ionide.FsNative.Analyzers.Tests.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzerTests
...
open Ionide.FsNative.Analyzers.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzer
