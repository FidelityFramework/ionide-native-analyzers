module Ionide.FsNative.Analyzers.Tests.Suggestion.HeadConsEmptyListPatternAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK.Testing
open Ionide.FsNative.Analyzers.Suggestion.HeadConsEmptyListPatternAnalyzer
