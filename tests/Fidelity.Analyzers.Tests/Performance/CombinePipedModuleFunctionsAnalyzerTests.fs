module Fidelity.Analyzers.Tests.Performance.CombinePipedModuleFunctionsAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK.Testing
open Fidelity.Analyzers.Performance.CombinePipedModuleFunctionsAnalyzer
