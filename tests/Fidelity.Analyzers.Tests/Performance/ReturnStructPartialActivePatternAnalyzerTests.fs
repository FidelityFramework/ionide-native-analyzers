module Fidelity.Analyzers.Tests.Performance.ReturnStructPartialActivePatternAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK
open FSharp.Analyzers.SDK.Testing
open Fidelity.Analyzers.Performance.ReturnStructPartialActivePatternAnalyzer
