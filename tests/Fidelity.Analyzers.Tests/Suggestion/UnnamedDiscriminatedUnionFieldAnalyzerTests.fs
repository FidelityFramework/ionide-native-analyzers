module Fidelity.Analyzers.Tests.Suggestion.UnnamedDiscriminatedUnionFieldAnalyzerTests

open NUnit.Framework
open FSharp.Compiler.CodeAnalysis
open FSharp.Analyzers.SDK.Testing
open Fidelity.Analyzers.Suggestion.UnnamedDiscriminatedUnionFieldAnalyzer
