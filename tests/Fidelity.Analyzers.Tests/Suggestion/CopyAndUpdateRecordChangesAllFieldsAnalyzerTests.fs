module Fidelity.Analyzers.Tests.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzerTests
...
open Fidelity.Analyzers.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzer
