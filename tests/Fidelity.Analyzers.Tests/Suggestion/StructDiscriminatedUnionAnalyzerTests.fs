module Fidelity.Analyzers.Tests.Suggestion.StructDiscriminatedUnionAnalyzerTests
...
open Fidelity.Analyzers.Suggestion.StructDiscriminatedUnionAnalyzer
...
// A special test case for https://github.com/ionide/fidelity-analyzers/issues/102
[<Test>]
