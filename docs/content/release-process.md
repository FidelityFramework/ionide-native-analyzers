...
A new release happens automatically when the version in the [Changelog](https://github.com/ionide/ionide-fsnative-analyzers/blob/main/CHANGELOG.md) was increased.  
