module Ionide.FsNative.Analyzers.Performance.ReturnStructPartialActivePatternAnalyzer
...
open Ionide.FsNative.Analyzers
...
[<Literal>]
let helpUri = "https://ionide.io/ionide-fsnative-analyzers/performance/009.html"
