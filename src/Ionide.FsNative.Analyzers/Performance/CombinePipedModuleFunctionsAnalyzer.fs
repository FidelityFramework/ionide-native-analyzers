module Ionide.FsNative.Analyzers.Performance.CombinePipedModuleFunctionsAnalyzer
...
open Ionide.FsNative.Analyzers.UntypedOperations

[<return: Struct>]
let (|PipeInfixApp|_|) synExpr =
    match synExpr with
    | SynExpr.App(funcExpr = OpPipeRight(_, e1); argExpr = e2) -> ValueSome(e1, e2)
    | _ -> ValueNone
...
[<Literal>]
let helpUri = "https://ionide.io/ionide-fsnative-analyzers/performance/010.html"
