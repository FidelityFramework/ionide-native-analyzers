module Ionide.FsNative.Analyzers.Performance.ListEqualsEmptyListAnalyzer
...
open Ionide.FsNative.Analyzers.TypedOperations
...
[<Literal>]
let helpUri = "https://ionide.io/ionide-fsnative-analyzers/performance/008.html"
