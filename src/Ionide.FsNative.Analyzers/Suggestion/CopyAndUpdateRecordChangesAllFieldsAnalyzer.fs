module Ionide.FsNative.Analyzers.Suggestion.CopyAndUpdateRecordChangesAllFieldsAnalyzer
...
[<Literal>]
let helpUri = "https://ionide.io/ionide-fsnative-analyzers/suggestion/001.html"
