module Ionide.FsNative.Analyzers.Suggestion.UnnamedDiscriminatedUnionFieldAnalyzer
...
[<Literal>]
let helpUri = "https://ionide.io/ionide-fsnative-analyzers/suggestion/004.html"
