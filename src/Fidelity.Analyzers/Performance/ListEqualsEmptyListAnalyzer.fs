module Fidelity.Analyzers.Performance.ListEqualsEmptyListAnalyzer
...
open Fidelity.Analyzers.TypedOperations
...
[<Literal>]
let helpUri = "https://ionide.io/fidelity-analyzers/performance/008.html"
