module Fidelity.Analyzers.Performance.ReturnStructPartialActivePatternAnalyzer
...
[<Literal>]
let helpUri = "https://ionide.io/fidelity-analyzers/performance/009.html"
