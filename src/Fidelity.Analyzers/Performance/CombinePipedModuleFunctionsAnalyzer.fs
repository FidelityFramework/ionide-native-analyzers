module Fidelity.Analyzers.Performance.CombinePipedModuleFunctionsAnalyzer
...
open Fidelity.Analyzers.UntypedOperations
...
[<Literal>]
let helpUri = "https://ionide.io/fidelity-analyzers/performance/010.html"
